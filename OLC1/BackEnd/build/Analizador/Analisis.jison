...
INTERFAZ : public interface identificador lla FUNCIONES llc {
 $$ = new Nodo("INTERFAZ", "",this._$.first_line-1,this._$.first_column-1);
                             ...
                             $$.hijos.push(new Nodo("LLAVE A", $4));
                             $$.hijos.push($5);
                             $$.hijos.push(new Nodo("LLAVE C", $6));
        }
        | interface identificador lla FUNCIONES llc {
 $$ = new Nodo("INTERFAZ", "",this._$.first_line-1,this._$.first_column-1);
                             $$.hijos.push(new Nodo("ID", $2));
                             $$.hijos.push(new Nodo("LLAVE A", $3));
                             $$.hijos.push($4);
                             $$.hijos.push(new Nodo("LLAVE C", $5));
        }
;
...
;
CLASES: CLASES CLASE {
    $$ = new Nodo("CLASE", "CLASE",this._$.first_line-1,this._$.first_column-1);
                             $$.hijos.push($1);
                             $$.hijos.push($2);
                            }
    | CLASE {$$ = new Nodo("CLASE", "CLASE",this._$.first_line-1,this._$.first_column-1);
                             $$.hijos.push($1);
                            }
    | PANIC {}
    ;
...
;
RETURN: return {  $$= new Nodo("RETURN", "",this._$.first_line-1,this._$.first_column-1);
}
...
PRINT: sout para parc {
     $$ = new Nodo("PRINT", "",this._$.first_line-1,this._$.first_column-1); 
     $$.hijos.push(new Nodo("PARENTESIS A", $2,this._$.first_line-1,this._$.first_column-1));
     $$.hijos.push(new Nodo("PARENTESIS C", $3,this._$.first_line-1,this._$.first_column-1));
}
|soutln para parc {
...
IF: if para EXPRESION parc BODY {  $$ = new Nodo("IF", "",this._$.first_line-1,this._$.first_column-1); 
$$.hijos.push(new Nodo("PARENTESIS A", $2,this._$.first_line-1,this._$.first_column-1));
	...
	| if para EXPRESION parc BODY else IF  {$$ = new Nodo("IF", "",this._$.first_line-1,this._$.first_column-1); 
    $$.hijos.push(new Nodo("PARENTESIS A", $2,this._$.first_line-1,this._$.first_column-1));
	...
	| if para EXPRESION parc BODY else BODY {$$ = new Nodo("IF", "",this._$.first_line-1,this._$.first_column-1); 
    $$.hijos.push(new Nodo("PARENTESIS A", $2,this._$.first_line-1,this._$.first_column-1));
...
FOR: for para TIPO identificador EXPRES puntocoma EXPRESION puntocoma ITERACION parc BODY {
                            $$.hijos.push(new Nodo("PARENTESIS A", $2,this._$.first_line-1,this._$.first_column-1));
                             $$ = new Nodo("FOR", "",this._$.first_line-1,this._$.first_column-1); 
                             $$.hijos.push($3);
...
WHILE: while para CONDICION parc BODY {
                     $$ = new Nodo("WHILE", "",this._$.first_line-1,this._$.first_column-1); 
                     $$.hijos.push(new Nodo("PARENTESIS A", $2,this._$.first_line-1,this._$.first_column-1));
...
DOWHILE: do BODY while para EXPRESION parc puntocoma {
                             ...
                             $$ = new Nodo("DOWHILE", "",this._$.first_line-1,this._$.first_column-1); 
                             $$.hijos.push($2);
...
BREAK: break {   $$= new Nodo("BREAK", "",this._$.first_line-1,this._$.first_column-1);
}
;
...
CONTINUE: continue  {
     $$= new Nodo("CONTINUE", "",this._$.first_line-1,this._$.first_column-1); 
}
