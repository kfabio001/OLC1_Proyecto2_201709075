...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.mostrar_Tokens = function () {
        var texto = "";
        texto = "<!DOCTYPE html> ";
        texto += "<html lang=\"en\">";
        texto += "<head>";
        ...
        texto += "<title>Reporte Tokens</title>";
        ...
        for (var i = 0; i < this.tokens.length; i++) {
            ...
            texto += "<td>" + "Error Sintattico" + "</td><td>" +
                this.tokens[i].lexema + "</td><td>" +
                this.tokens[i].fila + "</td>\n";
            this.tokens[i].columna + "</td>\n";
            texto += "</tr>\n";
            No = No + 1;
        }
        texto += "</tbody> \n";
